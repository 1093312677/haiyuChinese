		...
		<div class="logo-box"><img src="<%=request.getContextPath()%>/haiyu/images/logo.png"></div>
			...
			<div class="login">
				<s:if test="#session.username==null">
					<a href="<%=request.getContextPath()%>/login.html">学员登录</a>
					<span>&nbsp;|&nbsp;</span>
		...
		<ul class="nav center clearfix">
			...
			<li>
				...
				<ul>
					...
					<li><a href="<%=request.getContextPath()%>/haiyu/vedio-zhaopin.html">活动信息</a></li>
				</ul>
			</li>
			<li>
				<span>|</span>
			...
			<div id="boxID">
				...
				<div class="pic">
					<ul class="clearfix">
						...
						<li>
							<a href="<%=request.getContextPath()%>/haiyu/teach-vedio.jsp">
