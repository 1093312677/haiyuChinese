...
<div class="container">
	<div class="row">
	  <form action="../Main_addVideoLocal.action" method="post" enctype="multipart/form-data">
	   ...
	   <div class="form-group">
			<label class="col-sm-2 control-label" for="videoName">视频文件</label>
			<div class="col-sm-10">	 
				 <input id="videoName" name='file' class="file" type="file" multiple data-min-file-count="1" required><br>
			</div>
	   </div>
	   <div class="form-group">
